          ...
          {phoneProducts.map((product, index) => (
            ...
            >
              ...
              <div className="relative aspect-square overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#124090]/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              </div>
