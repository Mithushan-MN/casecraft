        ...
        >
            <div className="mx-auto flex max-w-7xl items-center justify-between px-4 lg:px-6">
                ...
                <div className="hidden lg:flex items-center gap-1 xl:gap-2">
                  ...
                  ${isActive ? "text-gray-900" : "text-gray-800 hover:text-[#FADC58]"}
                  after:absolute after:bottom-1 after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-0.5 after:bg-[#FADC58] after:transition-all hover:after:w-8`
                        }
                    >
                        Home
                    </NavLink>
                    ...
                    <NavLink
                        ...
                        className={({ isActive }) =>
                            `relative px-5 py-3 text-md font-semibold transition-all duration-300
                  ${isActive ? "text-[#FADC58]" : "text-gray-800 hover:text-[#FADC58]"}
                  after:absolute after:bottom-1 after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-0.5 after:bg-[#FADC58] after:transition-all hover:after:w-8`
                        }
                    >
                        Phone Cases
                  ...
                  after:absolute after:bottom-1 after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-0.5 after:bg-[#FADC58] after:transition-all hover:after:w-8`
                    ...
                    >
                        <button
                            ...
                            className={`px-3 xl:px-4 py-2 text-md font-semibold rounded-lg transition-all flex items-center gap-1 ${
                                infoOpen || isInfoPageActive
                                    ? "text-[#FADC58] bg-yellow-50"
                                    : "text-gray-800 hover:text-[#FADC58] hover:bg-yellow-50"
                            }`}
                        >
                            Info
                            <ChevronDown
                        ...
                        {infoOpen && (
                            <div className="absolute right-0 w-48 rounded-xl bg-white shadow-xl py-2 border border-gray-100 z-50">
                                <NavLink to="/about" className="block px-4 py-2.5 text-md font-semibold text-gray-700 hover:text-[#FADC58] hover:bg-yellow-50">About Us</NavLink>
                                <NavLink to="/blog" className="block px-4 py-2.5 text-md font-semibold text-gray-700 hover:text-[#FADC58] hover:bg-yellow-50">Blog</NavLink>
                                <NavLink to="/store-locator" className="block px-4 py-2.5 text-md font-semibold text-gray-700 hover:text-[#FADC58] hover:bg-yellow-50">Store Locator</NavLink>
                                <NavLink to="/contact" className="block px-4 py-2.5 text-md font-semibold text-gray-700 hover:text-[#FADC58] hover:bg-yellow-50">Contact</NavLink>
                                <NavLink to="/faq" className="block px-4 py-2.5 text-md font-semibold text-gray-700 hover:text-[#FADC58] hover:bg-yellow-50">FAQ</NavLink>
                            </div>
                        )}
                    </div>
                    ...
                    {user?.role !== "admin" && (
                        ...
                        >
                            <NavLink
                                to="/user/cart"
                                className="relative px-4 py-3 bg-gradient-to-r from-[#FADC58] to-[#C79F2B] text-gray-900 rounded-full font-bold shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center gap-2"
                            >
                                ...
                                {cartOpen && items.length > 0 && (
                                    ...
                                    >
                                        ...
                                        <div className="p-4 bg-yellow-50/50 space-y-3">
                                            ...
                                            <Link
                                                to="/checkout"
                                                className="block w-full text-center py-2.5 bg-gradient-to-r from-[#FADC58] to-[#C79F2B] text-gray-900 rounded-xl font-bold shadow-lg hover:shadow-xl transition-all text-sm"
                                            >
                                                Checkout Now
                                            </Link>
                                        </div>
                    ...
                    {loading ? (
                        ...
                        <div className="relative ml-6" ref={profileRef}>
                            ...
                            >
                                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#FADC58] to-[#C79F2B] flex items-center justify-center text-gray-900 font-bold text-lg shadow-lg">
                                    {initial}
                                </div>
                        ...
                        <NavLink
                            ...
                            className="px-8 py-3 bg-gradient-to-r from-[#FADC58] to-[#C79F2B] text-gray-900 rounded-full font-bold shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center gap-2 ml-4"
                        >
            ...
            >
                <div className="px-4 pt-4 pb-6 space-y-2 bg-gray-50 border-t border-gray-200">
                    <NavLink to="/" onClick={() => setOpen(false)} className="block px-4 py-3 text-md font-semibold text-gray-800 hover:text-[#FADC58]">Home</NavLink>
                    <NavLink to="/custom-mobilecase" onClick={() => setOpen(false)} className="block px-4 py-3 text-md font-semibold text-gray-800 hover:text-[#FADC58]">Phone Cases</NavLink>
                    {/* <NavLink to="/pet-center" onClick={() => setOpen(false)} className="block px-4 py-3 text-md font-semibold text-gray-800 hover:text-[#FADC58]">Pet Gifts</NavLink> */}
                    <NavLink to="/CaseCraftBusinessPage" onClick={() => setOpen(false)} className="block px-4 py-3 text-md font-semibold text-gray-800 hover:text-[#FADC58]">Become a Owner</NavLink>

                    {/* INFO DROPDOWN MOBILE */}
                    <div className="space-y-1">
                        <button
                            onClick={() => setInfoOpen(!infoOpen)}
                            className="w-full flex items-center justify-between px-4 py-3 text-md font-semibold text-gray-800 hover:text-[#FADC58]"
                        >
                            <span>Info</span>
                        ...
                        {infoOpen && (
                            <div className="pl-4 space-y-1">
                                <NavLink to="/about" onClick={() => setOpen(false)} className="block px-4 py-2 text-md font-semibold text-gray-600 hover:text-[#FADC58]">About Us</NavLink>
                                <NavLink to="/blog" onClick={() => setOpen(false)} className="block px-4 py-2 text-md font-semibold text-gray-600 hover:text-[#FADC58]">Blog</NavLink>
                                <NavLink to="/store-locator" onClick={() => setOpen(false)} className="block px-4 py-2 text-md font-semibold text-gray-600 hover:text-[#FADC58]">Store Locator</NavLink>
                                <NavLink to="/contact" onClick={() => setOpen(false)} className="block px-4 py-2 text-md font-semibold text-gray-600 hover:text-[#FADC58]">Contact</NavLink>
                                <NavLink to="/faq" onClick={() => setOpen(false)} className="block px-4 py-2 text-md font-semibold text-gray-600 hover:text-[#FADC58]">FAQ</NavLink>
                            </div>
                        )}
                    </div>
                    ...
                    {user?.role !== "admin" && (
                        <NavLink
                            to="/user/cart"
                            onClick={() => setOpen(false)}
                            className="flex items-center justify-between px-4 py-3 mt-2 text-sm font-semibold rounded-lg bg-gradient-to-r from-[#FADC58] to-[#C79F2B] text-gray-900 transition-all shadow-lg"
                        >
                    ...
                    {loading ? (
                        ...
                        <div className="px-4 py-3 rounded-lg bg-white mt-4 shadow-md">
                            <div className="flex items-center gap-3 mb-3">
                                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-[#FADC58] to-[#C79F2B] text-gray-900 font-bold text-md shadow-md">
                                    {initial}
                                </div>
                                <div className="flex-1 min-w-0">
                        ...
                        <NavLink
                            to="/login"
                            onClick={() => setOpen(false)}
                            className="w-full max-w-xs mx-auto text-center py-3 bg-gradient-to-r from-[#FADC58] to-[#C79F2B] text-gray-900 rounded-full font-bold shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 flex justify-center items-center gap-2 mt-4"
                        >
                            <Sparkles className="w-5 h-5" />
                            Login
                        </NavLink>
